...
public abstract class Render<T extends Entity>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if(Client.Client.NAMETAG) {
        this.renderNameTag(entity, x, y, z);
        }
        if(Client.Client.NAMETAG2) {
            this.renderNameTag2(entity, x, y, z);
            }
        
           // this.renderNameTag3(entity, x, y, z);
    ...
    protected void renderNameTag2(T entity, double x, double y, double z)
    {
        if (this.canRenderName(entity))
        {
            this.renderLivingLabel(entity, entity.getDisplayName().getFormattedText(), x, y, z, 64);
    ...
    protected void renderNameTag3(T entity, double x, double y, double z)
    {
        if (this.canRenderName(entity))
        {
            this.renderLivingLabel(entity, entity.getDisplayName().getFormattedText(), x, y, z, 64);
