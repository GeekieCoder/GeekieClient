...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void renderNameTag(T entity, double x, double y, double z)
    {
    	 if (this.canRenderName(entity))
         {
            ...
            if (d0 < (double)(f * f))
            {
                ...
                String s = "" + (int)entity.getHealth() + "§4❤";
                float f1 = 0.02666667F;
                GlStateManager.alphaFunc(516, 0.1F);
                if (entity.isSneaking())
                {
                ...
                {
                    this.renderOffsetLivingLabel(entity, x, y - (entity.isChild() ? (double)(entity.height / 2.0F) : -0.25D), z, s, 0.02666667F, d0);
                }
                }
            }
        }
    ...
    public void renderNameTag2(T entity, double x, double y, double z)
    {
    ...
    public void renderNameTag3(T entity, double x, double y, double z)
    {
            ...
            if (d0 < (double)(f * f))
            {
                ...
                if (entity.isSneaking())
                {
                    ...
                    FontRenderer fontrenderer = this.getFontRendererFromRenderManager();
                    GlStateManager.pushMatrix();
                    GlStateManager.translate((float)x, (float)y + entity.height + 0.5F - (entity.isChild() ? entity.height / 2.0F : -0.25F), (float)z);
                    GL11.glNormal3f(0.0F, 1.0F, 0.0F);
                    GlStateManager.rotate(-this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
                    GlStateManager.rotate(this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
                    GlStateManager.scale(-0.02666667F, -0.02666667F, 0.02666667F);
