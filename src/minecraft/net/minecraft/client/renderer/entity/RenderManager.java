...
public class RenderManager
{
    ...
    public void renderWitherSkull(Entity entityIn, float partialTicks)
    {
        ...
        if (render != null && this.renderEngine != null)
        {
            ...
            render.renderNameTag(entityIn, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ);
            render.renderNameTag2(entityIn, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ);
        }
    }
