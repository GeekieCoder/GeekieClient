...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(Client.Client.getCameraYaw() + (Client.Client.getCameraYaw() - Client.Client.getCameraYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(Client.Client.getCameraPitch() + (Client.Client.getCameraPitch() - Client.Client.getCameraPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = Client.Client.getCameraYaw();
                float f2 = Client.Client.getCameraPitch();
                ...
                GlStateManager.rotate(Client.Client.getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(Client.Client.getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - Client.Client.getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - Client.Client.getCameraPitch(), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (this.mc.inGameHasFocus && flag && Client.Client.overriderMouse())
        {
