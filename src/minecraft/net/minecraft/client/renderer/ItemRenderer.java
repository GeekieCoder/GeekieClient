    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (abstractclientplayer.getItemInUseCount() > 0)
            {
                ...
                {
                    case NONE:
                        this.transformFirstPersonItem(f, abstractclientplayer.getSwingProgress(partialTicks));
                        break;

                    case EAT:
                    case DRINK:
                    	if(Client.Client.EatDrink) {
