...
import Client.FeaturedServer.ServerDataFeatured;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	Client.Client.getDiscordRP().update("Idle", "Multiplayer Menu");
    ...
    {
        return p_175392_2_ > this.savedServerList.getFeaturedServersCount();
    }
