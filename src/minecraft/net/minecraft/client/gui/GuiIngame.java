...
import Client.RenderUtils.IngameRenderer;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
		...
		if(Client.Client.ping) {
			...
			//	mc.fontRendererObj.drawStringWithShadow("Ping§f " + "0", 0, 30, 11037889);	
			}else {
				//mc.fontRendererObj.drawStringWithShadow("Ping§f " + mc.getMinecraft().getCurrentServerData().pingToServer, 0, 30, 11037889);
			}
		}
        IngameRenderer.renderIngameUtils();
